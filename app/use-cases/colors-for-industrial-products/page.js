      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10 text-gray-600 dark:text-gray-400">
            ...
            <p className="mb-4 leading-relaxed">
              Product color palettes start as design intent (often in HEX for concept and rendering) and are translated into material specs: RAL, Pantone, or supplier-specific references for paint, plastic, and fabric. Designers should document both digital and physical values so that packaging, labels, and marketing use the same colors as the product. A <InlineTagLink href="/tools/palette-generator">color palette generator</InlineTagLink> helps explore harmonies and lock hex values for renders, configurators, and web; those values can then be mapped to the closest available material standards or used to brief suppliers on custom colors.
            </p>
            <p className="mb-4 leading-relaxed">
              Packaging and collateral should use the same core palette so that unboxing and point-of-sale feel aligned with the product. Linking to proven <InlineTagLink href="/palettes/black-and-gold">palettes for premium products</InlineTagLink> (e.g. black and gold for tools or appliances) gives design and marketing a shared starting point and keeps the system manageable as the product line grows.
            </p>
          </section>
          ...
          <section className="mb-10 text-gray-600 dark:text-gray-400">
            ...
            <p className="mb-4 leading-relaxed">
              Many industrial and consumer products include apps, configurators, or embedded interfaces. UI colors should align with the product and brand palette so that the digital experience reinforces the physical one. Text and controls need sufficient contrast for readability and safety-critical information. An <InlineTagLink href="/tools/contrast-checker">accessibility contrast checker</InlineTagLink> ensures that accent colors used on buttons or labels do not break contrast requirements for body text or critical indicators. Use high-contrast pairs for primary content and reserve brand accent colors for highlights and secondary elements.
            </p>
