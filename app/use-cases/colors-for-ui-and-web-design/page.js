      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10 text-gray-600 dark:text-gray-400">
            ...
            <p className="mb-4 leading-relaxed">
              After defining the palette, teams document hex or RGB values in a style guide and map them to semantic names. Those names become design tokens in Figma, Sketch, or Adobe XD and the same tokens in code as CSS custom properties or theme objects. A <InlineTagLink href="/tools/palette-generator">color palette generator</InlineTagLink> can help explore harmonies from a single base color and export hex codes for primary, secondary, and neutral scales. Preview the five roles on dashboard, landing page, or mobile mockups with our{' '}
              <InlineTagLink href="/tools/color-palette-preview">website color palette preview</InlineTagLink> before committing tokens. Once values are chosen, plug them into variables so that one change propagates across the entire product.
            </p>
